...
#Robot
urdf = "/talos_data/robots/talos_reduced_corrected_mod.urdf"
...
DURATION_SS = 0.1  # duration of the single support phases
...
kp_posture = 0.005  # proportional gain of joint posture task
...
## Friction cone
lxp = 1.11                                  # foot length in positive x direction
lxn = 1.11                                  # foot length in negative x direction
lyp = 1.06                                  # foot length in positive y direction
lyn = 1.06                                  # foot length in negative y direction
