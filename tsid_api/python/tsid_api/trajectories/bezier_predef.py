...
import math
from ..util.cs_util import generate_effector_trajectories_for_sequence

pinocchio.switchToNumpyArray()

class EffectorInputsBezier():
...
def generate_effector_trajectories_for_sequence_bezier(cfg, cs,  output_, fullBody = None):
    return generate_effector_trajectories_for_sequence(cfg, cs, generateSmoothBezierTraj, output_, fullBody)
