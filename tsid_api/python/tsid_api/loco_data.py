...
class LocoData:
    ...
    def __init__(self, input_location, output_location):
        ...
        self.SingleOptSavings = data["SingleOptResultSavings"]
        ...
        if "TerrainModel" in data:
            ...
            self.terrain_flag = True#leave it to be always true
    ...
    def refine(self):
	    ...
	    #Get quaternion
            TSIDTrajectory["Init_L_quat"] = self.getQuaternion(self.SingleOptSavings[roundIdx]["LeftInitSurf"])
            TSIDTrajectory["Init_R_quat"] = self.getQuaternion(self.SingleOptSavings[roundIdx]["RightInitSurf"])
            TSIDTrajectory["Landing_quat"] = self.getQuaternion(self.SingleOptSavings[roundIdx]["ContactSurfs"][0])
            
            #---------------------------
	    #Old Code for getting the quaternion
