...
#ifndef TSID_API_DEPRECATED_HH
# define TSID_API_DEPRECATED_HH
...
//  void foo () TSID_API_DEPRECATED;
//
// Tagging a type as deprecated:
//  class Foo {};
//  typedef Foo Bar TSID_API_DEPRECATED;
//
// Tagging a variable as deprecated:
//  int a TSID_API_DEPRECATED = 0;
//
...
#  define TSID_API_DEPRECATED __attribute__ ((deprecated))
# else
#  if defined(_MSC_VER) && !defined(__INTEL_COMPILER)
#   define TSID_API_DEPRECATED __declspec (deprecated)
#  else
// If the compiler is not recognized, drop the feature.
#   define TSID_API_DEPRECATED /* nothing */
#  endif // __MSVC__
# endif // __GNUC__

#endif //! TSID_API_DEPRECATED_HH
