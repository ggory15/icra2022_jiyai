...
#ifndef TSID_API_WARNING_HH
# define TSID_API_WARNING_HH

// Emits a warning in a portable way.
//
// To emit a warning, one can insert:
//
// #pragma message TSID_API_WARN("your warning message here")
//
...
# define TSID_API_WARN_STRINGISE_IMPL(x) #x
# define TSID_API_WARN_STRINGISE(x) \
         TSID_API_WARN_STRINGISE_IMPL(x)
# ifdef __GNUC__
#   define TSID_API_WARN(exp) ("WARNING: " exp)
# else
#  ifdef _MSC_VER
#   define FILE_LINE_LINK __FILE__ "(" \
           TSID_API_WARN_STRINGISE(__LINE__) ") : "
#   define TSID_API_WARN(exp) (FILE_LINE_LINK "WARNING: " exp)
#  else
// If the compiler is not recognized, drop the feature.
#   define TSID_API_WARN(MSG) /* nothing */
#  endif // __MSVC__
# endif // __GNUC__

#endif //! TSID_API_WARNING_HH
