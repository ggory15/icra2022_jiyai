...
import numpy as np
from tsid_ggory.tsid_wb import *
...
output_name = '6LookAhead_ws'
output_ = input_location + output_name
cs_wb = generate_wholebody_tsid(cfg, cs_ref, robot, viz)
cs_wb.saveAsBinary(output_)
